...
contract ERC721 is IERC721, IERC721Metadata {
    ...
    function balanceOff(address owner) public view returns(uint) {
    ...
    function _safeMint(address to, uint tokenId, bytes memory data) internal virtual {
        _mint(to, tokenId);
        require(_chekOnERC721Received(address(0), to, tokenId, data), "non-erc721 receiver");
    }
    ...
    function _transfer(address from, address to, uint tokenId) internal {
        require(ownerOf(tokenId) == from, "incorretct owner!");
